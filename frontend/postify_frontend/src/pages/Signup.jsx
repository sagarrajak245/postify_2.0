        ...
        <div className="flex min-h-screen">
            ...
            <div className="hidden w-full bg-gradient-to-b from-purple-400 to-purple-800 lg:flex lg:w-1/2 flex-col items-center justify-center p-12 text-white">
                <div className="max-w-md">
                    ...
                    <h1 className="mb-6 text-4xl font-bold">Get Started with Us</h1>
                    <p className="mb-12 text-xl">Complete these easy steps to register your account.</p>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center rounded-lg bg-purple-500/30 p-4">
                            ...
                            <span className="text-xl">Sign up your account</span>
                        </div>
                        ...
                        <div className="flex items-center rounded-lg bg-purple-500/30 p-4">
                            ...
                            <span className="text-xl">Set up your workspace</span>
                        </div>
                        ...
                        <div className="flex items-center rounded-lg bg-purple-500/30 p-4">
                            ...
                            <span className="text-xl">Set up your profile</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full bg-black lg:w-1/2 flex items-center justify-center p-8">
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-gray-400">Enter your personal data to create your account.</p>
                    </div>

                    <div className="mt-8 space-y-6">
                        <div className="flex gap-4">
                            <Button variant="outline" className="w-full p-2 bg-white hover:bg-gray-100 text-black">
                        ...
                        <Button className="w-full p-2 bg-white hover:bg-gray-100 text-black">Sign Up</Button>
